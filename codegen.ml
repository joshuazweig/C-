...
let translate (globals, functions) =
  ...
  let mint_div_print_func_t = L.function_type i32_t [| mint_type |] in 
  let mint_div_print_func = L.declare_function "mint_div_print_func" mint_div_print_func_t the_module in
